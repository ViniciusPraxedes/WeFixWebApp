        ...
        <table class="table table-bordered">
            ...
            <c:forEach items="${payments}" var="payment">
                <tr>
                    ...
                    <td>${payment.time}</td>
                    <td>${payment.paid}</td>
                    <td><a href="deletePayment?id=${payment.id}" class="btn btn-danger">DELETE FROM DATABASE</a> </td>
                    <td><a href="updateIsPaid?id=${payment.id}" class="btn btn-success">MARK AS PAID</a> </td>
                    <td><a href="updateIsPaidAgain?id=${payment.id}" class="btn btn-warning">MARK AS UNPAID</a> </td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
